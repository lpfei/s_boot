...
var appMaster = {
    ...
    ThemeSwitcher: function () {
        ...
        var blueConfig = function () {
            $('link[title=mainStyle]').attr('href', '/static/btzero/css/styles-blue.css');
            $('.navbar-brand img').attr('src', '/static/btzero/img/logo-blue.png');
            $('img.ipad-image').attr('src', '/static/btzero/img/samples/ipad-bl.png');
            $('img.macbook-image').attr('src', '/static/btzero/img/samples/macbook-bl.png');
        }
        var orangeConfig = function () {
            $('link[title=mainStyle]').attr('href', '/static/btzero/css/styles-orange.css');
            $('.navbar-brand img').attr('src', '/static/btzero/img/logo-orange.png');
            $('img.ipad-image').attr('src', '/static/btzero/img/samples/ipad-bl.png');
            $('img.macbook-image').attr('src', '/static/btzero/img/samples/macbook-bl.png');
        }
        var redConfig = function () {
            $('link[title=mainStyle]').attr('href', '/static/btzero/css/styles-red.css');
            $('.navbar-brand img').attr('src', '/static/btzero/img/logo-red.png');
            $('img.ipad-image').attr('src', '/static/btzero/img/samples/ipad-rd.png');
            $('img.macbook-image').attr('src', '/static/btzero/img/samples/macbook-rd.png');
        }
